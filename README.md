...
- The published container: ghcr.io/deterrey/secat:v5.0.2
...
## Quick start
    ...
    nextflow pull DETerrey/SeCAT -r v5.0.2
    cp params.yaml my_params.yaml       # set manifest, reference_db, outdir, bind_paths
    nextflow run DETerrey/SeCAT -r v5.0.2 -profile slurm,singularity -params-file my_params.yaml
...
(params_paper.yaml, manifest, roster). Run it against release v5.0.2.
