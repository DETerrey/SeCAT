process EXTRACT_TAXON_IMPACT {
    ...
    cache 'lenient'
    label 'mem_8g'
    publishDir(path: { "${params.final_outputs}/${params.final_outputs_taxon_impact_dir}" }, mode: 'copy', pattern: "*.csv")
    publishDir(path: { "${params.final_outputs}/${params.final_outputs_taxon_impact_dir}" }, mode: 'copy', pattern: "README.txt")
