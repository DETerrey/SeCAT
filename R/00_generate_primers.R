...
#   - output/intermediate/primer_coordinates.csv — primer coordinates
...
# primer pair to process. This maps to a row in primer_coordinates.csv.
...
PRIMER_COORDS_CSV <- "output/intermediate/primer_coordinates.csv"
