...
MAFFT_PATH                    <- .secat_env("SECAT_MAFFT_PATH",   "mafft")
...
MAFFT_ALIGNMENTS_DIR          <- file.path(OUTDIR, "mafft_alignments")
...
MAFFT_EXTRA_OPTIONS           <- .secat_env("SECAT_MAFFT_OPTIONS",           "--retree 1 --anysymbol")
SAVE_MAFFT_ALIGNMENTS         <- .secat_env("SECAT_SAVE_MAFFT_ALIGNMENTS",   TRUE, "logical")
